...
<style>
  ...
  height: 2.5rem;      */
	...
	background: #bdc3c7;  */
		...
		/*background: radial-gradient(at center, rgb(230, 230, 230), rgba(108, 168, 222, 1));*/
	...
	.resp-tabs-list {
		...
		background-image: linear-gradient(160deg, #0093E9 0%, #166158 100%);
	}
...
<?php if (isset($_GET['error'])) {
	if ($_GET['error'] === 'sameval') {
		echo '<script>alert("Please select different values for departure city and arrival city")</script>';
	} elseif ($_GET['error'] === 'seldep') {
		echo '<script>alert("Please select Departure city")</script>';
	} elseif ($_GET['error'] === 'selarr') {
		echo "<script>alert('Please select Arrival city')</script>";
	}
} ?>
...
<div class="conatiner-fluid p-4" style="background-color: whitesmoke;">
	...
	<div class="slideshow-container">
		...
		<div class="mySlides fade1">
			...
			<div class="text">Fly Your Dreams: Book Your Journey with Us!</div>
		</div>

		<div class="mySlides fade1">
			<div class="numbertext">2 / 3</div>
			<img src="assets/images/2.png" style="width:100%">
			<div class="text">Unlock the World Above: Your Flight Awaits!</div>
		</div>

		<div class="mySlides fade1">
			<div class="numbertext">3 / 3</div>
			<img src="assets/images/3.png" style="width:100%">
			<div class="text">Enjoy traveling with your loved ones</div>
		</div>
	...
	<div class="sap_tabs">
		<div id="horizontalTab">
			<ul class="resp-tabs-list">
				<li class="resp-tab-item"><span class="ex1">Round Trip</span></li>
				<li class="resp-tab-item"><span class="ex2">One way</span></li>
			</ul>
...
<div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;">
	<h2 class="text-center mb-3 mt-3 display-4" style="font-style: normal;font-size:30px;">Explore with confidence</h2>
								...
								<div class="flex-container">
									...
									<div class="testimonial_slide flex-item">
										<div class="testi_detail">
											<div class="card1">
												<img src="assets/images/s1.png" alt="John" style="width:100%">
												<div style="padding: 2.4rem;">
													<p class="title1">Safety and well-being</p>
													<p>Find out what it’s like to travel in the new normal</p>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="testimonial_slide flex-item">
										<div class="testi_detail">
											<div class="card1">
												<img src="assets/images/s2.png" alt="John" style="width:100%">

												<div style="padding: 2.4rem;">
													<p class="title1">Travel rules and requirements</p>
													<p> Check the latest information to fly with no setbacks</p>
												</div>
									...
									<div class="testimonial_slide flex-item">
										<div class="testi_detail">
											<div class="card1">
												<img src="assets/images/s3.png" alt="John" style="width:100%">

												<div style="padding: 2.4rem;">
													<p class="title1">Flexible travel options</p>
													<p> Change of plans? See your options here</p>
												</div>
