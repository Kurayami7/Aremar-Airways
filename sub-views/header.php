...
<head>
    ...
    <title>Aremar Airways - Your Journey Awaits!</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent header">


        <a class="navbar-brand" href="index.php">
            <div class="logo">
                <h5 class="text-light">
                    <img src="assets/images/logo10.png" height="" width="" alt="">
    ...
    <div style="margin-top: 81px; /* Adjust margin to account for fixed header height */
            ">
    </div>