...
<main>
  ...
  if (isset($_POST['search_but'])) { // If the search flights button is clicked: 
    $dep_date = $_POST['dep_date'];

    if (isset($_POST['ret_date'])) {
      $ret_date = $_POST['ret_date'];
    } else {
      $ret_date = null; // Default value for returnDate keeping one-round flights in mind
    }
